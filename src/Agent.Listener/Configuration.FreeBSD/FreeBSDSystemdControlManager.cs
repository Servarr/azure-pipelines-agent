...
{
    [ServiceLocator(Default = typeof(FreeBSDSystemDControlManager))]
    public interface IFreeBSDServiceControlManager : IAgentService
    {
        void GenerateScripts(AgentSettings settings);
    }

    public class FreeBSDSystemDControlManager : ServiceControlManager, IFreeBSDServiceControlManager
    {
        // This is the name you would see when you do `service -l | grep vsts`
        ...
        private const string _shTemplate = "service.svc.sh.template";
